"""
train/dataset.py
Extends the base RawVideoDataset with:
  - WeightedRandomSampler  : fixes class imbalance without duplicating files
  - MixUp augmentation     : blends two clips to improve generalisation
  - Hard negative mining   : oversamples clips the model recently got wrong
"""
